...
model = joblib.load("./src/random_forest_model.pkl")  # Assuming the model is in ./src/

with open('./src/logindata.json', 'r') as f:
    users = json.load(f)

with open('./src/loginauthentication.json', 'r') as f:
